...
class TestFirstSmoke(BaseCase):
    ...
    def test_get_mo_info_extended(self, get_mo_info_extended_fmba_covid19):

        assert get_mo_info_extended_fmba_covid19.status_code == 200, 'Wrong response status code'
